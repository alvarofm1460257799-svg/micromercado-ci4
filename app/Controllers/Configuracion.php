...
{
    protected $configuracion,$detalleRoles;
    protected $reglas;
    ...
    public function actualizar()
    {
        if($this->request->getMethod() =="post" && $this->validate($this->reglas)){
            ...
            /*echo $img->getName();//nombre de la imagen
            echo $img->getSize();//tamaño kb
            echo $img->getExtension();//extencions*/
            ...
            //$img->move(WRITEPATH. '/uploads'); guarda en su carpeta predefida
