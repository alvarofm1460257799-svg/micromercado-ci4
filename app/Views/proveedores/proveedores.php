        ...
        <div class="container-fluid">
            ...
            <div>
                <p>
                    ...
                    <a href="<?= base_url(); ?>/proveedores/importarVista" class="btn btn-success">
            ...
            <table id="id_datatable" class="table table-striped table-bordered table-hover table-sm table-darck" style="font-size: 14px;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 5%;">Listar Productos</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td > 
                                    <br>
                                    <a href="<?php echo base_url() . '/proveedores/listar_productos/' . $dato
                                    ['id']; ?>" class="btn btn-primary btn-sm" data-placement="top" title="Editar Registro">Detalles <i class="fas fa-list-alt"></i></a>

                                    <td   > <a href="<?php echo base_url() . '/proveedores/editar/' . $dato['id']; ?>" 
                                    class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Editar Registro">Editar <i class="fas fa-pencil-alt"></i></a>
                                    <br><br>

                                    <a href="#" data-href="<?php echo base_url() . '/proveedores/eliminar/' . $dato['id']; ?>" 
                                    data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Eliminar Registro" class="btn btn-danger btn-sm">Borrar 
