            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <input class="form-control" id="monto_inicial" name="monto_inicial" value="<?php echo $arqueo['monto_inicial'];?>" 
                        type="number" readonly />
                    </div>
                    <div class="col-12 col-sm-6">
                        <label>Monto Final </label>
                        <input class="form-control" id="monto_final" name="monto_final" value="<?php echo $arqueo['monto_final'];?>" 
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <input class="form-control" id="total_ventas" name="total_ventas" value="<?php echo $monto['total']?> " 
                        type="text" readonly />
                    </div>
                    <div class="col-12 col-sm-6">
                        <label>Total ventas </label>
                        <input class="form-control" id="cantidad_ventas" name="cantidad_ventas" value="<?php echo $cantidadVenta['cantidad_ventas']?> " 
                        type="text" readonly />
                    </div>
