<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <input type="hidden" name="id" id="id" value="<?php echo $producto['id']; ?>"disabled>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        type="text" value="<?php echo $producto['nombre']; ?>" disabled />
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <input class="form-control" id="precio_venta" name="precio_venta" type="number" 
                        value="<?php echo $producto['precio_venta']; ?>" step="0.01" disabled />
                </div>

                <div class="col-12 col-sm-6">
                    <label>Precio compra</label>
                    <input class="form-control" id="precio_compra" name="precio_compra" 
                        type="number" value="<?php echo $producto['precio_compra']; ?>" step="0.01" disabled />
                </div>
            ...
            <input 
                ...
                type="date" 
                value="<?php echo isset($producto['fecha_vencimiento']) ? $producto['fecha_vencimiento'] : ''; ?>" 
                disabled />
        </div>
            ...
            <div class="form-group">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <br>
                            <input type="file" id="img_producto" name="img_producto" accept="image/*" disabled/>
